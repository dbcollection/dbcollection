...
def pad_list(listA, val=-1, length=None):
    """Pads list of lists with a value such that all lists have
    the same length.
    ...
    val : number, optional
        Value to pad the lists. Default: -1.
    length : number, optional
        Total length of the list. Default: None.
...
def unpad_list(listA, val=-1):
    """Unpads a list of lists contiain a value 'val' as padding.
    ...
    val : number, optional
        Value to unpad the lists. Default: -1.
...
def squeeze_list(listA, val=-1):
    """Compacts a list of lists into a single list.

    Squeezes (spaghettifies) a list of lists into a single list.
    ...
    listA : list
        List of lists.
    val : number, optional
        Value to separate the lists. Default: -1.
