...
class TestDataCacheManager:
    ...
    def __init__(self):
        ...
        self.list_datasets = ["dataset" + i for i in range(10)]
        self.list_categories = ["category" + i for i in range(10)]
        self.list_tasks = ["task" + i for i in range(10)]
    ...
    def get_random_size_list_tasks(self):
        ...
        tasks = random.shuffle(self.list_tasks[:num_tasks])
        return tasks
    ...
    def get_random_size_list_categories(self):
        ...
        categories = random.shuffle(self.list_categories[:num_categories])
        return categories
    ...
    def get_list_categories_used(self, datasets):
        """Returns a list of all categoires available in the datasets data."""
        categories_used = []
        for dataset in datasets:
            categories_used.extend(dataset['keywords'])
    ...
    def get_datasets_tasks_by_category(self, category):
        ...
        for dataset in self.datasets:
            list_datasets_tasks.update({
                dataset: self.get_tasks_by_category(dataset["tasks"], category)
            })
