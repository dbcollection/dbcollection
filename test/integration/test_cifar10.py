...
dbclt.setup(name='cifar10', data_dir='/home/mf/tmp/download_data', verbose=True, is_test=True)

# download dataset
print('==> dbcollection.download:')
loader = dbclt.load(name='cifar10', task='classification', verbose=True, is_test=True)
