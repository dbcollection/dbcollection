...
"""
Test downloading the Pascal VOC 2007 dataset.
"""
...
dbclt.setup(name='pascal_voc_2007', data_dir='/home/mf/tmp/download_data', verbose=True, is_test=True)

# download dataset
print('==> dbcollection.download:')
loader = dbclt.load(name='pascal_voc_2007', verbose=True, is_test=True)
