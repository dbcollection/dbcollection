...
print('\n==> dbcollection: load()')
mpii = dbc.load(name='mpii_pose', task='keypoints', data_dir=data_dir, verbose=True, is_test=True)
...
# print data from the loader
print('\n######### info #########')
print('Dataset: ' + mpii.name)
print('Task: ' + mpii.task)
print('Data path: ' + mpii.data_dir)
print('Metadata cache path: ' + mpii.cache_path)
