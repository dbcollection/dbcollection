--[[
    Test downloading+processing  a dataset using the dbcollection API.
]]
...
dbc.load({name=opt.name, data_dir=opt.data_dir, verbose=true, is_test=true})
